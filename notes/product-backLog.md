...
| arch01 |   02   |   main   | As a dummy user i want to see a sketched out layout for the research page to get a feel for the layout  | a pencil and paper sketch of the general layout can be found in the sketches, 5 users shall be asked about their opinion and thoughts about the current layout |        |
| arch01 |   03   |   main   | As a user i want to see the basic layout of the research page  |  -specs- |        |
| arch01 |   04   |  admins  | As admin I want to add and edit researches on research page  | The admin shall be able to add and manage the differenet research articles                              |        |
